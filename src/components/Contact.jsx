    ...
    <section id="contact" className="relative py-20 sm:py-24 px-4 sm:px-6" aria-label="Contact section">
      <div className="max-w-2xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.15 }} transition={{ duration: 0.6, type: 'spring', stiffness: 100 }}>
          ...
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-black mb-5 sm:mb-6" style={{ color: c.textPrimary }}>
            Let's build something <span style={{ color: c.accent }}>great</span>
          </h2>
          ...
          <div className="flex justify-center mb-8 sm:mb-10">
            <a href="mailto:guruvishnu4gd@gmail.com" className="inline-flex items-center gap-3 hover:opacity-70" style={{ color: c.textPrimary }}>
              <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl border flex items-center justify-center" style={{ borderColor: c.cardBorder, backgroundColor: c.card }}>
